...
import os,sys
import pandas as pd
from air_quality.constant import training_pipeline
...
class ModelPusherConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.bucket_name: str = training_pipeline.BUCKET_NAME
        self.s3_model_key_path: str = training_pipeline.S3_MODEL_DIR_NAME